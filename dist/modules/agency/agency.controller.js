...
const getTourPlans = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield agency_service_1.agencyService.getPlans(paginationOptions, filter, req === null || req === void 0 ? void 0 : req.user);
    (0, sendRespnse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
...
const updateTourPlan = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (error) {
        ...
        const id = Number(req.params.id);
        const result = yield agency_service_1.agencyService.updateTourPlan(Object.assign(Object.assign({}, req.body), { id }), (_b = req === null || req === void 0 ? void 0 : req.user) === null || _b === void 0 ? void 0 : _b.userId);
        (0, sendRespnse_1.default)(res, {
            statusCode: http_status_codes_1.StatusCodes.OK,
            success: true,
...
const deleteTourPlan = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _c;
    const id = Number(req.params.id);
    const result = yield agency_service_1.agencyService.deleteTourPlan(id, (_c = req === null || req === void 0 ? void 0 : req.user) === null || _c === void 0 ? void 0 : _c.userId);
    (0, sendRespnse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
        message: 'Plan updated successfylly',
