...
const getPlans = (meta, filterOptions, endUser) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userQueries = (0, agency_utils_1.getPlanByRoleQuery)(endUser, queryOption);
    const result = yield prisma.plans.findMany(Object.assign({ skip: Number(skip), take,
        orderBy }, userQueries));
    const totalCount = (endUser === null || endUser === void 0 ? void 0 : endUser.role) === 'agency'
