...
const agency_utils_1 = require('./agency.utils');
...
const getPlans = (meta, filterOptions, endUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userQueries = (0, agency_utils_1.getPlanByRoleQuery)(
      endUser,
      queryOption
    );
    const result = yield prisma.plans.findMany(
      Object.assign({ skip: Number(skip), take, orderBy }, userQueries)
    );
    const totalCount =
      (endUser === null || endUser === void 0 ? void 0 : endUser.role) ===
      'agency'
        ? yield prisma.plans.count({
            where: { agency_id: endUser.userId },
          })
        : yield prisma.plans.count();
...
const getTourPlanById = (id, user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    console.log(id, user);
    if (
      user &&
      (user === null || user === void 0 ? void 0 : user.role) == 'agency'
    ) {
...
const deleteTourPlan = (plan_id, agency_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
