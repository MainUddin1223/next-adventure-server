...
const getAgencies = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.adminService.getAllAgencies(
      paginationOptions,
      filter
    );
...
const getTourPlans = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.adminService.getAllTourPlan(
      paginationOptions,
      filter
    );
    (0, sendRespnse_1.default)(res, {
...
const getAllBookings = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.adminService.getAllBookings(
      paginationOptions,
      filter
    );
    (0, sendRespnse_1.default)(res, {
...
const getPayouts = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const paginationOptions = yield (0, pagination_1.pagination)(req.query);
    const filter = (0, pick_1.default)(
      req.query,
    ...
    const result = yield admin_service_1.adminService.getPayouts(
      paginationOptions,
      filter
    );
    (0, sendRespnse_1.default)(res, {
...
const relaseAgencyPayout = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
