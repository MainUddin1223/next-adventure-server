...
const getAllAdmins = (meta, filterOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, admin_utils_1.commonGetAllUserQuery)(meta, filterOptions, 'admin');
    return result;
});
const getAllUsers = (meta, filterOptions) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('service', meta);
    const result = yield (0, admin_utils_1.commonGetAllUserQuery)(meta, filterOptions, 'user');
    return result;
});
const getAllAgencies = (meta, filterOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, admin_utils_1.commonGetAllUserQuery)(meta, filterOptions, 'agency');
    return result;
});
const getAllTourPlan = (meta, filterOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllBookings = (meta, filterOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const { skip, take, orderBy, page } = meta;
    const queryOption = {};
    if (Object.keys(filterOptions).length) {
        const { search } = filterOptions, restOptions = __rest(filterOptions, ["search"]);
...
const getPayouts = (meta, filterOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const { skip, take, orderBy, page } = meta;
    const queryOption = {};
    if (Object.keys(filterOptions).length) {
        const { search } = filterOptions, restOptions = __rest(filterOptions, ["search"]);
    ...
    const result = agencies.map(agency => {
        ...
        return Object.assign(Object.assign({}, agency), { groupedPayouts: Object.values(payoutByStatus) });
    });
...
const relaseAgencyPayout = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const createAdmin = (id, role) => __awaiter(void 0, void 0, void 0, function* () {
