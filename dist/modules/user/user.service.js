...
const getUpcomingSchedules = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const manageBookings = (id, userId) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllBookings = (meta, filterOptions, id) => __awaiter(void 0, void 0, void 0, function* () {
    const { skip, take, orderBy, page } = meta;
    const queryOption = {};
    if (Object.keys(filterOptions).length) {
        const { search } = filterOptions, restOptions = __rest(filterOptions, ["search"]);
...
const leaveReview = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
