...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = yield jwtHelpers_1.jwtHelpers.createToken(accessData, config_1.default.jwt.jwt_access_secret, config_1.default.jwt.expires_in, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
...
const registerAgency = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = Object.assign(Object.assign({}, payload), { password: hash });
    const result = yield prisma.users.create({
        data: Object.assign(Object.assign({}, data), { role: 'agency' }),
    });
    const accessData = { role: result.role, userId: result.id };
    const accessToken = yield jwtHelpers_1.jwtHelpers.createToken(accessData, config_1.default.jwt.jwt_access_secret, config_1.default.jwt.expires_in, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
    const userData = yield auth_utils_1.authUtils.getAgencyData(result.id);
    return { result: userData, accessToken };
});
const signin = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = yield jwtHelpers_1.jwtHelpers.createToken(payload, config_1.default.jwt.jwt_access_secret, config_1.default.jwt.expires_in, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
    if (isUserExist.role === 'admin' || isUserExist.role === 'super_admin') {
        const userData = yield auth_utils_1.authUtils.getAdminData(isUserExist.id);
        return { result: userData, accessToken };
    }
    else if (isUserExist.role === 'agency') {
        const userData = yield auth_utils_1.authUtils.getAgencyData(isUserExist.id);
        return { result: userData, accessToken };
    }
    else {
