...
exports.validateUpdateSchema = exports.signUpValidateSchema = exports.signinValidateSchema = exports.registerValidateSchema = void 0;
...
exports.registerValidateSchema = joi_1.default.object({
    ...
    role: joi_1.default.string()
        .valid(auth_constants_1.roles[0], ...auth_constants_1.roles)
        .required()
        .messages({
        'any.required': 'Role field is required',
        'any.only': `Role field must be one of ${[...auth_constants_1.roles]}`,
    }),
