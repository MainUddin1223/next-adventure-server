...
const signUp = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { error } = yield auth_validation_1.signUpValidateSchema.validate(req.body);
    if (error) {
...
const registerAgency = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { error } = yield auth_validation_1.registerValidateSchema.validate(req.body);
    if (error) {
        (0, sendRespnse_1.default)(res, {
            statusCode: http_status_codes_1.StatusCodes.NON_AUTHORITATIVE_INFORMATION,
            success: false,
...
const signin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { error } = yield auth_validation_1.signinValidateSchema.validate(req.body);
    if (error) {
        (0, sendRespnse_1.default)(res, {
            statusCode: http_status_codes_1.StatusCodes.NON_AUTHORITATIVE_INFORMATION,
            success: false,
...
const getProfile = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { error } = yield auth_validation_1.validateUpdateSchema.validate(req.body);
    if (error) {
        (0, sendRespnse_1.default)(res, {
            statusCode: http_status_codes_1.StatusCodes.NON_AUTHORITATIVE_INFORMATION,
            success: false,
...
const updateProfile = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.authService.updateProfile(req.body, userId);
    (0, sendRespnse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
        message: 'Profile fatched successfully',
...
const signOut = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _c;
    const result = yield auth_service_1.authService.signOut((_c = req.user) === null || _c === void 0 ? void 0 : _c.userId);
    (0, sendRespnse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
        message: 'Registration successful',
