...
exports.verifyAgency = exports.verifySuperAmdin = exports.verifyAuth = exports.verifyUser = exports.verifyAdmin = void 0;
...
const verifyAuthWithRole = (allowedRoles) => {
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const decoded = jwtHelpers_1.jwtHelpers.verifyToken(token, config_1.default.jwt.jwt_access_secret);
            req.user = decoded;
            if (!decoded.userId) {
                return res.status(401).json({ message: 'Unauthorized' });
            }
